...
[![Skills](https://img.shields.io/badge/specialist_skills-25-brightgreen?style=flat-square)](#whats-inside--25-specialist-agents)
[![Domains](https://img.shields.io/badge/learning_domains-20%2B-blueviolet?style=flat-square)](#learning-domains)
...
**25 specialist agents · 3 daily pillars · 20+ learning domains · 24/7 file-based memory · L0→L10 progression**
...
20 seeded domains, each with a full **L0→L10 curriculum**, 30/60/90-day roadmap, session log, progress tracker, metrics, playbook, and leveled resources. New domains are added by copying `domains/TEMPLATE/` — `interest-scout` proposes them from curiosity signals, humans approve.

| Category | Domains |
|---|---|
| **Physical** | Running · Swimming · Strength & Plyometrics · Kung-Fu · Mobility & Recovery · Driving *(theory-only until legal age)* |
| **Sciences** | Physics · Chemistry · Biology |
| **World** | Geography · Geopolitics · General Law |
| **Mind** | Brain Training · Strategy & Decisions |
| **Expression** | Language · Literature · Drawing · Behavior & Etiquette |
| **Practical** | Agriculture · Engineering & Making · *+ any elective you add* |

## What's inside — 25 specialist agents
...
| **Coaches & mentors** | 6 | Dedicated coaches (run/swim/strength/kung-fu/driving) + `domain-mentor` engine teaching any domain |
